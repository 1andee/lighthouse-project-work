function calculateDayInYear(date) {
  ...
  function validMonth(month) {
    return month && month >= 1 && month <= 12;   // Revised comparison operators include December
  }
  ...
  function calculateDayNumber(month, day) {
    ...
    dayOfYear += day;                     // The script now correctly tracks the day
    return dayOfYear - 1;
  }

  function daysInFeb(year) {
    return (isLeapYear(year) ? 29 : 28)   // Checks if leap year
  }
